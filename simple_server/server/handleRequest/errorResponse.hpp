...
namespace b_net_errs {
    ...
    http::message_generator
        bad_request
        (const std::string why, const int version, const bool keep_alive)
    {
    ...
    http::message_generator
        not_found
        (std::string target, const int version, const bool keep_alive)
    {
    ...
    http::message_generator
        server_error
        (const std::string what, const int version, const bool keep_alive)
    {
